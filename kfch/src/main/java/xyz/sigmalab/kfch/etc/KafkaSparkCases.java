...
public class KafkaSparkCases {
    ...
    // 1: KafkaSparkCases.firstCase("first-case", kafkaServer, KafkaUtil.NoOffsetStrategy.EARLIEST)
    // 2: KafkaSparkCases.firstCase("first-case", kafkaServer, KafkaUtil.NoOffsetStrategy.LATEST) ;
